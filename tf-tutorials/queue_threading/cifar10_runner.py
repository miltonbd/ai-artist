...
data_path = "/home/milton/dataset/cifar/cifar10/"
batch_size = 128
num_threads = 8
...
def cifar_shuffle_batch():
    ...
    filename_list = [data_path + 'data_batch_{}'.format(i + 1) for i in range(5)]
...
def cifar_filename_queue(filename_list):
    ...
    # create the queue
    fq = tf.RandomShuffleQueue(10, 20, tf.string)
    ...
    tf.train.add_queue_runner(tf.train.QueueRunner(fq, [fq_enqueue_op] * num_threads))
    return fq
